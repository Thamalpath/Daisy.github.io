    ...
    <div class="container">
        ...
        <div class="col-sm-12 mt-3">
            <div class="headline text-center mb-3">
                <h2 class="pb-3 position-relative d-inline-block">MEN'S WEAR</h2>
            </div>
        </div>
        </div>
                ...
                <form action="" method="GET">
                    <div class="card shadow mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <?php
                            $subcategory_query = "SELECT * FROM sub_category WHERE cat_id = '1' AND sub_cat_status='1' ";
            ...
            <div class="col-md-9">
                ...
                <div class="card-body row">
                    ...
                    ?>
                        ...
                        $product = "SELECT * FROM product WHERE cat_id = '1' ";
                        $product_run = mysqli_query($con, $product);
                        if (mysqli_num_rows($product_run) > 0) {
                            foreach ($product_run as $proditems) :
                                ?>
